...
## Projects Included
1. Caesar Cipher: A text encryption tool that shifts letters in the alphabet. Supports encoding and decoding with any shift value.

2. Tic‑Tac‑Toe: A two‑player console game with win detection, board display, and replay support.
